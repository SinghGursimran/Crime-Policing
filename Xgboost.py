"""
Created on Mon May 15 01:46:08 2017

@author: Team-Crime Policing
"""
...
data = pd.read_csv('C:/Users/asdf/Desktop/BTP - Gursimran Singh/train1.csv', parse_dates=['Dates'])
#data = pd.read_csv('C:/Users/asdf/Downloads/train.csv', parse_dates=['Dates'])
#data = pd.read_csv('C:/Users/asdf/Downloads/train.csv', parse_dates=['Dates'])
data = data[:30000]
